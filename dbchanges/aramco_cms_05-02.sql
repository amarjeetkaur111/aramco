...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 02, 2023 at 11:07 AM
...
INSERT INTO `idea_request` (`id`, `users_id`, `track_channel`, `idea_name`, `idea_problem`, `idea_solution`, `idea_resource_requirement`, `contributors`, `point_of_contact`, `current_implementation_level`, `technology`, `attachment`, `status_of_request`, `date_of_request`, `created_at`, `updated_at`) VALUES
(1, 11, 'test track idea', 'idea detail', '', '', '', 'there is no contributor', 'sasassss', 0, 0, 'adadda', 'Pending', '2023-04-25', '2023-04-19 10:04:35', '2023-04-19 10:04:35');
...
CREATE TABLE IF NOT EXISTS `schedule_visit_request` (
  ...
  `justification` text NOT NULL,
  `additional_info` text NOT NULL,
  `status_of_request` enum('Pending','Approved','Rejected') NOT NULL DEFAULT 'Pending',
  `date_of_request` date DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
