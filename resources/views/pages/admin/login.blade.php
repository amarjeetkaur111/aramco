            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Aramco</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Saudi Aramco! 👋</h4>
              ...
              <!-- <form id="formAuthentication" class="mb-3" action="index.html" method="POST">
                ...
                <!-- <div class="mb-3 form-password-toggle">
                  <div class="d-flex justify-content-between">
                    <label class="form-label" for="password">Batch No</label>
              ...
              <a href="{{ url('auth/google') }}" style="margin-top: 0px !important;background: #C84130;color: #ffffff;padding: 8px;border-radius:6px;" class="btn">
