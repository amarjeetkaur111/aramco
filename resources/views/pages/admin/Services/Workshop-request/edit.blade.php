                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        <div class="card-header d-flex align-items-center justify-content-end">
                            ...
                            <button data-href="{{ route('admin-service-workshop-request-change-status', ['id' => $data->id]) }}" class="btn rounded-pill btn-primary float-right status-change">Change status</button>
                        </div>
                        <div class="card-body">
                            <form method="post" action="{{ route('admin-service-workshop-request-store') }}" enctype="multipart/form-data" id="form_id">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <input name="workshop_name" value="{{ $data->workshop_name ?? "" }}" type="text" class="form-control"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <input name="num_of_people" value="{{ $data->num_of_people ?? "" }}" type="number" class="form-control"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <input name="point_of_contact" value="{{ $data->point_of_contact ?? "" }}" type="text" class="form-control"
...
@push('custom-scripts')
    ...
    <script>
        ...
        $('.edit-data').on('click', function (){
            $('input[type="text"], input[type="datetime-local"], input[type="number"]').prop("readonly", false);
            $('#update_data').show();
        });
