                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        <div class="card-header d-flex align-items-center justify-content-end">
                            ...
                            <button data-href="{{ route('admin-service-visit-change-status', ['id' => $data->id]) }}" class="btn rounded-pill btn-primary float-right status-change">Change status</button>
                        </div>
                        <div class="card-body">
                            <form method="post" action="{{ route('admin-service-visit-update') }}" enctype="multipart/form-data" id="form_id">
                                @csrf

                                <input type="hidden" value="{{ $data->id }}" name="visit_id">
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <input name="visit_title" value="{{ $data->visit_title ?? "" }}" type="text" class="form-control"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <input name="num_of_visitors" value="{{ $data->num_of_visitors ?? "" }}" type="text" class="form-control"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <input name="visitor_coordinator_contact" value="{{ $data->visitor_coordinator_contact ?? "" }}" type="text" class="form-control"
