                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        <div class="card-header d-flex align-items-center justify-content-end">
                            ...
                            <button data-href="{{ route('admin-service-event-request-change-status', ['id' => $data->id]) }}" class="btn rounded-pill btn-primary float-right status-change">Change status</button>
                        </div>
                        <div class="card-body">
                            <form method="post" action="{{ route('admin-service-event-request-store') }}" enctype="multipart/form-data" id="form_id">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <input name="event_name" value="{{ $data->event_name ?? "" }}" type="text" class="form-control"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <input name="space_name" value="{{ $data->space_name ?? "" }}" type="text" class="form-control" id="space_name_id"
                                        ...
                                        <div class="input-group input-group-merge">
                                            @foreach($required_request as $request)
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input other-field" type="checkbox" name="required_resources[]" id="required_resources_{{$loop->iteration}}" value="{{ $request->id }}"
                                                    {{ (in_array($request->id, explode(',', $data->required_resources))) ? "checked" : "" }}>
                                                    <label class="form-check-label" for="required_resources_{{$loop->iteration}}">{{ $request->name }}</label>
                                                </div>
                                            @endforeach
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-3" id="other_div" hidden>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <input name="other_required_resource" value="{{ $data->other_required_resource ?? "" }}" type="text" id="other_required_resource_id" class="form-control" placeholder="Other Required Resources Here"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <input name="num_of_attendees" value="{{ $data->num_of_attendees ?? "" }}" type="number" class="form-control" id="num_of_attendees_id"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <input name="coordinator_contact" value="{{ $data->coordinator_contact ?? "" }}" type="text" class="form-control" id="coordinator_contact_id"
