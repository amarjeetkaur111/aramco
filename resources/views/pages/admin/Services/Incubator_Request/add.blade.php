                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('admin-service-incubator-request-store') }}" enctype="multipart/form-data" id="form_id">
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label required-star" for="usecase_name_id">Contact of Usecase</label>
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <input name="contact_of_usecase" value="{{ old('contact_of_usecase') }}" type="text" class="form-control"
                                                   id="usecase_name_id" placeholder="Event Name Here" data-parsley-errors-container="#usecase_name_error"
                                                   required/>
                                        </div>
                                        <span class="text-danger" id="event_name_error"></span>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <input name="num_of_employees" value="{{ old('num_of_employees') }}" type="number" class="form-control" id="num_of_attendees_id"
