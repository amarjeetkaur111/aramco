                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('admin-service-idea-request-store') }}" enctype="multipart/form-data" id="form_id">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-merge">
                                            <input name="track_channel" value="{{ old('track_channel') }}" type="text" class="form-control"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-merge">
                                            <input name="idea_name" value="{{ old('idea_name') }}" type="text" class="form-control" id="idea_name_id"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-merge">
                                            <input name="idea_problem" value="{{ old('idea_problem') }}" type="text" class="form-control" id="idea_problem_id"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-merge">
                                            <input name="idea_solution" value="{{ old('idea_solution') }}" type="text" class="form-control" id="idea_solution_id"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-merge">
                                            <input name="idea_resource_requirement" value="{{ old('idea_resource_requirement') }}" type="text" class="form-control" id="idea_resource_requirement_id"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-merge">
                                            <input name="contributors" value="{{ old('contributors') }}" type="text" class="form-control" id="contributors_id"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-merge">
                                            <input name="point_of_contact" value="{{ old('point_of_contact') }}" type="text" class="form-control" id="point_of_contact_id"
                                        ...
                                        <div class="input-group input-group-merge">
                                            <select class="form-control" name="current_implementation_level" id="current_implementation_level_id" data-parsley-errors-container="#current_implementation_level_error" required>
                                                ...
                                                @foreach($implementation_level as $key => $level)
                                                    <option value="{{ $key }}" {{ (old('current_implementation_level') == $key) ? 'selected' : '' }}>{{ $level }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="input-group input-group-merge">
                                            <select class="form-control other-field" name="technology" id="technology_id" data-parsley-errors-container="#technology_error" required>
                                                ...
                                                @foreach($technology as $key => $data)
                                                    <option value="{{ $key }}" {{ (old('technology') == $key) ? 'selected' : '' }}>{{ $data }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row mb-3" id="other_div" hidden>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-merge">
                                            <input name="other_technology" value="{{ old('other_technology') }}" type="text" class="form-control"
