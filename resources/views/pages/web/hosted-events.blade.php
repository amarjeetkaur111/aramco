        ...
        <div class="col-12 d-flex justify-content-start align-items-center">
          <nav class="aram-breadcrumb">
              <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item active">My Hosted Events</li>
              </ol>
          </nav>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="pageheading my-3">
              <div class="sicon"><img src="{{asset('assets/web/images/icons/24/host-an-event-blue.svg')}}" class="img-fluid" /></div><div class="stext">Hosted Events</div>
          </div>
          ...
          <form class="hostedEventForm" data-parsley-validate data-parsley-excluded="input[type=button], input[type=submit], input[type=reset], input[type=hidden], [disabled], :hidden" >
            ...
            <div class="row mb-4 font-1-5rem">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-end align-items-end">
                <button type="button" class="btn btn-primary" onClick="hostedEventsValidate()">Save Changes</button>
              </div> 
