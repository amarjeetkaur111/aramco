    ...
    <div class="container min-vh-70">
      ...
      <div class="row justify-content-between align-items-center mt-3 ">
        <div class="col-md-12 col-sm-12 col-12 d-flex justify-content-start align-items-center">
          <a href="{{route('manage-reserved-technology-workshop')}}" class="pagesTopNavLink"><span class="sicon"><img src="{{asset('assets/web/images/icons/24/black-arrow-left.svg')}}" class="img-fluid" /></span>Back</a>
        </div>
      </div>
          ...
          <div class="row mt-5 font-1-5rem">
            ...
            <div class="row mb-4 font-1-5rem">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-start align-items-end gap-3 mt-3">
                ...
                <button type="button" class="btn btn-success rounded-4 py-1" onClick="reservedTechnologyWorkshopSpaceValidate()">Accept</button>
                <button type="button" class="btn btn-primary rounded-4 py-1" onClick="reservedTechnologyWorkshopSpaceModifyValidate()">Modify</button>
