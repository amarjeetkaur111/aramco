        ...
        <div class="col-12 d-flex justify-content-start align-items-center">
          <nav class="aram-breadcrumb">
              <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item active">My Allocated Computing Resources</li>
              </ol>
          </nav>
        </div>
      </div>
          ...
          <form class=" allocatedComputingResourcesForm" data-parsley-validate data-parsley-excluded="input[type=button], input[type=submit], input[type=reset], input[type=hidden], [disabled], :hidden" >
            ...
            <div class="row mb-4 font-1-5rem">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-end align-items-end">
                <button type="button" class="btn btn-primary" onClick="allocatedComputingResourcesValidate()">Save Changes</button>
              </div> 
