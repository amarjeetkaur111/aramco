        ...
        <div class="row gutters">
            ...
            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                <div class="pageheading my-3">
                    <div class="sicon"><img src="{{asset('assets/web/images/icons/24/reserve-incubator-blue.svg')}}"
                                            class="img-fluid"/></div>
                    <div class="stext">Reserve Incubator</div>
                </div>
                ...
                <p class="pagesubheading mb-2">To reserve an incubator please fill the data form below</p>

                <form class="reserveIncubatorForm" data-parsley-validate
                      data-parsley-excluded="input[type=button], input[type=submit], input[type=reset], input[type=hidden], [disabled], :hidden"
                      method="post" action="{{ route('services-reserve-incubator-store') }}">
                    @csrf
                    ...
                    <div class="row mt-5 mb-4 font-1-5rem">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Available Rooms<span
                                        class="text-red">*</span></label>
                                <div class="col-sm-10">
                                    <select class="form-control" name="space_name" data-parsley-required
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Main contact of the use case<span
                                        class="text-red">*</span></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="contact_of_usecase"
                                           data-parsley-required data-parsley-errors-container="#sv-e4" placeholder="Enter.."/>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">No.of employees working on use case<span
                                        class="text-red">*</span></label>
                                <div class="col-sm-10">
                                    <input type="number" min="1" value="1" class="form-control" data-parsley-required
                                           data-parsley-errors-container="#sv-e5" name="num_of_employees"/>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label">Justification<span
                                        class="text-red">*</span></label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" rows="3" name="justification" maxlength="100"
                                              data-parsley-required
                                              data-parsley-errors-container="#justification-e5" placeholder="Enter.."></textarea>
                                    <div class="errorMsg d-none" id="justification-e5"></div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" rows="3" name="additional_info" maxlength="100"
                                              data-parsley-required
                                              data-parsley-errors-container="#additional_info-e5" placeholder="Enter.."></textarea>
                                    <div class="errorMsg d-none" id="additional_info-e5"></div>
...
@push('custom-scripts')
    <script>
        ...
        var scheduleVisitValidate = () => {
            $('.reserveIncubatorForm').parsley().validate();

            if ($('.reserveIncubatorForm').parsley().isValid()) {
