        ...
        <!-- <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
          <div class="card border-0 rounded-3" >
            ...
            <div class="list-group w-100 serviceListLinks " id="serviceListLinks">
              ...
              <a href="{{route('manage-reserved-technology-workshop')}}" class="list-group-item list-group-item-action active">
                  <i class="serviceLine">
                      <span class="line"><span class="inner"></span></span>
                    </svg>
                  </i>
                      ...
                      <td>
                        <div class="user-item justify-content-end">
                          <div class="saction m-0">
                            <a class="saction-link" href="{{route('services/manage-technology-workshop-form')}}"><img src="{{asset('assets/web/images/icons/24/table-user-view.svg')}}" class="img-fluid" /></a>
                          </div>
                        </div>
                      </td>
                    </tr>
