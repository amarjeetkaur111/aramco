          ...
          <ul class="list-unstyled invite-user-list mb-0" id="invite-user-list">
            <!-- <li>
                <div class="invite-user">
                  ...
                  <button class="btn btn-primary rounded-4 py-1 ms-auto invite-user-btn" data-name='a1' data-email='a1@a.com'>Invite</button>
                </div>
            </li> -->
          </ul>
        </div>
        ...
        <div class="border-bottom mb-3">
          <div class="invited-user-list-heading">
            <div class="d-flex flex-row pageheading mb-2">
              ...
              <button class="btn btn-primary rounded-4 py-1 ms-auto">Send Invites</button>
              <button type="button" class="btn btn-danger rounded-4 py-1 ms-4">Cancel</button>
            </div>
          </div>
        </div>
...
<script src="{{asset('assets/web/plugins/jquery-resizable/dist/jquery-resizable.min.js')}}"></script>
    ...
    <script>
       ...
       var reservedIncubatorsValidate = () => {
        ...
        var userListObjArray = [
          {"id": "user01", "name": "Adam 01", "email": "adam01@gmail.com", "invited": "true" },
          {"id": "user02", "name": "Adam 02", "email": "adam02@gmail.com", "invited": "false" },
          {"id": "user03", "name": "Adam 03", "email": "adam03@gmail.com", "invited": "true" },
          {"id": "user04", "name": "Adam 04", "email": "adam04@gmail.com", "invited": "false" },
          {"id": "user05", "name": "Adam 05", "email": "adam05@gmail.com", "invited": "true" },
          {"id": "user06", "name": "Adam 06", "email": "adam06@gmail.com", "invited": "false" },
          {"id": "user07", "name": "Adam 07", "email": "adam07@gmail.com", "invited": "true" },
          {"id": "user08", "name": "Adam 08", "email": "adam08@gmail.com", "invited": "false" },
          {"id": "user09", "name": "Adam 09", "email": "adam09@gmail.com", "invited": "true" },
          {"id": "user10", "name": "Adam 10", "email": "adam10@gmail.com", "invited": "false" },
          {"id": "user11", "name": "Adam 11", "email": "adam11@gmail.com", "invited": "true" },
          {"id": "user12", "name": "Adam 12", "email": "adam12@gmail.com", "invited": "false" },
          {"id": "user13", "name": "Adam 13", "email": "adam13@gmail.com", "invited": "true" },
          {"id": "user14", "name": "Adam 14", "email": "adam14@gmail.com", "invited": "false" },
          {"id": "user15", "name": "Adam 15", "email": "adam15@gmail.com", "invited": "true" },
          {"id": "user16", "name": "Adam 16", "email": "adam16@gmail.com", "invited": "false" },
          {"id": "user17", "name": "Adam 17", "email": "adam17@gmail.com", "invited": "true" },
          {"id": "user18", "name": "Adam 18", "email": "adam18@gmail.com", "invited": "false" },
          {"id": "user19", "name": "Adam 19", "email": "adam19@gmail.com", "invited": "true" },
          {"id": "user20", "name": "Adam 20", "email": "adam20@gmail.com", "invited": "false" },
        ];

var btnClass ;
$.each( userListObjArray, function (index,value) {

    if(value.invited =="true")
      btnClass = "btn-gray";
    else
    ...
    $("#invite-user-list").append(
        '<li>'+
          '<div class="invite-user">'+
            ...
            '<button class="btn '+btnClass +' rounded-4 py-1 ms-auto invite-user-btn" data-id="'+value.id +'" data-name="'+value.name +'" data-email="'+value.email +'" data-invited="'+value.invited +'" >Invite</button>'+
          '</div>'+
        '</li>'
    );
    if(value.invited =="true")
...
$.each( userListObjArray, function (index,value) {
  ...
  $('body').on('click','.invite-user-btn',function(e) {
    ...
    // invited.push({'name':$name,'email': $email});
    // console.log(invited);
  });
