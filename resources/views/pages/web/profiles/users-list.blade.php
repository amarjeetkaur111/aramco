    ...
    <div class="row justify-content-between align-items-center my-2">
        <div class="col-6 d-flex justify-content-start align-items-center">
            <div class="pageheading">
                ...
                <div class="stext">Users List</div>
            </div>
        </div>
        <div class="col-6 d-flex justify-content-end align-items-center">
            <div class="dropdown-center">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item table-filter-droptext" href="{{route('users_list',['status'=> 'Full Access User'])}}">Full Access User</a></li>
                    <li><a class="dropdown-item table-filter-droptext" href="{{route('users_list',['status'=> 'Limited Access User'])}}">Limited Access User</a></li>
                    <li><a class="dropdown-item table-filter-droptext" href="{{route('users_list',['status'=> ''])}}">All Users</a></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-scroll-table ">
                        <table class="table table-borderless align-middle" id="user-table">
                            ...
                            <tbody id="data-wrapper">
                                @include('pages.web.profiles.load-user-data')                       
                            </tbody>
                        </table>
                    </div>
