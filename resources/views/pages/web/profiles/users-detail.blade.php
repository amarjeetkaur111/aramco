...
<link href="{{asset('assets/web/css/aramco.css')}}" rel="stylesheet" />
    ...
    <div class="row justify-content-between align-items-center mt-5 mb-2">
      <div class="col-md-12 col-sm-12 col-12 d-flex justify-content-start align-items-center">
        <a href="{{route('users_list')}}" class="pagesTopNavLink"><span class="sicon"><img src="{{asset('assets/web/images/icons/24/black-arrow-left.svg')}}" class="img-fluid" /></span>Back</a>
      </div>
    </div>
      ...
      <div class="row justify-content-between align-items-center my-2">
        <div class="col-12 d-flex justify-content-start align-items-center">
            <div class="pageheading">
                <div class="sicon"><img src="{{asset('assets/web/images/icons/24/user-completion.svg')}}" class="img-fluid" /></div><div class="stext">User Detail</div>
            </div>
        </div>
      </div>
    </div>
          ...
          <div class="row gutters">
            ...
            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
              ...
              <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                  <div class="form-floating mb-5">
                    <input type="text" class="form-control" placeholder="Country" readonly   value="{{$data->nationality}}">
                    <label>Country</label>
                  </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
