    ...
    <div class="container min-vh-70">
      ...
      <div class="row justify-content-between align-items-center mt-3 ">
        <div class="col-md-12 col-sm-12 col-12 d-flex justify-content-start align-items-center">
          <a href="{{route('manage-service-hosted-event')}}" class="pagesTopNavLink"><span class="sicon"><img src="{{asset('assets/web/images/icons/24/black-arrow-left.svg')}}" class="img-fluid" /></span>Back</a>
        </div>
      </div>
      ...
      <div class="row gutters">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          ...
          <form class="hostedEventForm" data-parsley-validate data-parsley-excluded="input[type=button], input[type=submit], input[type=reset], input[type=hidden], [disabled], :hidden" >
          ...
          <div class="row mt-5 font-1-5rem">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="1" name="req-res"> <!-- data-parsley-required data-parsley-mincheck="2" data-parsley-errors-container="#he-e0" -->
                      <label class="form-check-label">Conference Theater</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="2" name="req-res">
                      <label class="form-check-label">CISCO conferencing</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="3" name="req-res">
                      <label class="form-check-label">Space for Booths</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="4" name="req-res">
                      <label class="form-check-label">Video Wall(s)/Projector Content</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="5" name="req-res">
                      <label class="form-check-label">Technology Exibition</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="6" name="req-res">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="row mb-3">
                  <label class="col-sm-4 col-form-label">Time of Visit </label>
                  <div class="col-sm-8">
            ...
            <div class="row mb-4 font-1-5rem">
              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="row mb-3">
                  <label class="col-sm-4 col-form-label">Visitors Coordinator Contact </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control"/>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="row mb-3">
                  <div class="col-sm-10 offset-sm-2">
                    <a href="{{route('send-invities')}}" class="btn btn-primary rounded-4 py-1">Send Invites</a>
                    <p class="mb-0 fs-5" style="color:#808080;">Send invites to remind attendies *</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-end align-items-end gap-3 mt-3">
                <button type="button" class="btn btn-success rounded-4 py-1" onClick="hostedEventsValidate()">Accept</button>
                <button type="button" class="btn btn-primary rounded-4 py-1" onClick="hostedEventsModifyValidate()">Modify</button>
