    ...
    <div class="container min-vh-70">
      ...
      <div class="row justify-content-between align-items-center mt-3 ">
        <div class="col-md-12 col-sm-12 col-12 d-flex justify-content-start align-items-center">
          <a href="{{route('manage-general-reservation')}}" class="pagesTopNavLink"><span class="sicon"><img src="{{asset('assets/web/images/icons/24/black-arrow-left.svg')}}" class="img-fluid" /></span>Back</a>
        </div>
      </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          ...
          <div class="row mt-5 font-1-5rem">
            ...
            <div class="row font-1-5rem">
              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <input type="date" class="form-control" onclick="(this.type='date')"/>
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <input type="time" class="form-control" onclick="(this.type='time')"/>
            ...
            <div class="row mb-4 font-1-5rem">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-12 d-flex justify-content-center align-items-end gap-3 mt-3">
                <button type="button" class="btn btn-success rounded-4 py-1" onClick="generalReservationValidate()">Accept</button>
                <button type="button" class="btn btn-primary rounded-4 py-1" onClick="generalReservationModifyValidate()">Modify</button>
...
@push('custom-scripts')
    <script>
       ...
       var generalReservationModifyValidate = () => {

        $('.checkfeedbackForm').removeClass('d-none');        
        $('.generalReservationForm').parsley().validate();
        $('.checkfeedbackForm').parsley().validate();

        if( $('.generalReservationForm').parsley().isValid() && $('.checkfeedbackForm').parsley().isValid() ){
          $('.formSuccess-modal').modal('show');
        }
       }
