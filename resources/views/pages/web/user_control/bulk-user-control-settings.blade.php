                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 user-control-setting">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8 col-sm-12 col-12">
                                    <form action="{{route('user-control-multiple-user-control-settings-post')}}" method="post">
                                        @csrf
                                        <input type="hidden" name="google_id[]" value="{{ json_encode($idArray) }}">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                                <div class="service-activity-container">
                                                    ...
                                                    <div class="service-activity-sub" style="display:none;">
                                                        <div class="u-controls">
                                                            ...
                                                            <div class="form-check form-switch ms-auto">
                                                                <input class="form-check-input success aram-form-check-input input-check"  type="checkbox" role="switch">
                                                                <input type="hidden" name="schedule_request" value="0">
                                                            </div>
                                                        </div>
                                                        <div class="u-controls">
                                                            ...
                                                            <div class="form-check form-switch ms-auto">
                                                                <input class="form-check-input success aram-form-check-input input-check"  type="checkbox"   role="switch">
                                                                <input type="hidden" name="robin_event_request" value="0">
                                                            </div>
                                                        </div>
                                                        <div class="u-controls">
                                                            ...
                                                            <div class="form-check form-switch ms-auto">
                                                                <input class="form-check-input success aram-form-check-input input-check"  type="checkbox" role="switch">
                                                                <input type="hidden" name="computing_resource_request" value="0">
                                                            </div>
                                                        </div>
                                                        <div class="u-controls">
                                                            ...
                                                            <div class="form-check form-switch ms-auto">
                                                                <input class="form-check-input success aram-form-check-input input-check"    type="checkbox" role="switch">
                                                                <input type="hidden" name="incubator_request" value="0">
                                                            </div>
                                                        </div>
                                                        <div class="u-controls">
                                                            ...
                                                            <div class="form-check form-switch ms-auto">
                                                                <input class="form-check-input success aram-form-check-input input-check"  type="checkbox" role="switch">
                                                                <input type="hidden" name="technology_workshop_request" value="0">
                                                            </div>
                                                        </div>
                                                        <div class="u-controls">
                                                            ...
                                                            <div class="form-check form-switch ms-auto">
                                                                <input class="form-check-input success aram-form-check-input input-check"    type="checkbox" role="switch">
                                                                <input type="hidden" name="idea_request" value="0">
                                                            </div>
                                                        </div>
                                                        <div class="u-controls">
                                                            ...
                                                            <div class="form-check form-switch ms-auto">
                                                                <input class="form-check-input success aram-form-check-input input-check"    type="checkbox" role="switch">
                                                                <input type="hidden" name="general_reservation_request" value="0">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="u-controls">
                                                    ...
                                                    <div class="form-check form-switch ms-auto">
                                                        <input class="form-check-input success aram-form-check-input input-check"    type="checkbox" role="switch">
                                                        <input type="hidden" name="connect" value="0">
                                                    </div>
                                                </div>
                                                <div class="u-controls">
                                            ...
                                            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                                ...
                                                <div class="u-controls">
                                                    ...
                                                    <div class="form-check form-switch ms-auto">
                                                        <input class="form-check-input success aram-form-check-input input-check"    type="checkbox" role="switch">
                                                        <input type="hidden" name="calendar" value="0">
                                                    </div>
                                                </div>
