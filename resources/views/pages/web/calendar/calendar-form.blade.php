...
{{--            <a href="{{ url()->previous() }}" class="pagesTopNavLink"><span class="sicon"><img src="{{asset('assets/web/images/icons/24/black-arrow-left.svg')}}" class="img-fluid" /></span>Back</a>--}}
{{--        </div>--}}
{{--    </div>--}}
    ...
    <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="pageheading mb-3">
                ...
                <div class="stext">Create a new event</div>
            </div>
        </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <form class="eventForm" data-parsley-validate data-parsley-excluded="input[type=button], input[type=submit], input[type=reset], input[type=hidden], [disabled]" action="{{ route('calender-admin-createPost') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mt-5 font-1-5rem">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" data-parsley-required data-parsley-errors-container="#he-e" name="title" />
                ...
                <div class="row font-1-5rem">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" data-parsley-required data-parsley-errors-container="#he-e1" name="start_date" />
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8">
                                <input type="date" class="form-control" data-parsley-required data-parsley-errors-container="#he-e2" name="end_date" />
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8">
                                <input type="time" class="form-control" data-parsley-required data-parsley-errors-container="#he-e3" name="start_time" />
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-8">
                                <input type="time" class="form-control" data-parsley-required data-parsley-errors-container="#he-e4" name="end_time" />
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="row mb-5">
                            ...
                            <div class="col-md-10 col-sm-8">
                                <textarea class="form-control" rows="3" data-parsley-required data-parsley-errors-container="#he-e5" name="description"></textarea>
                ...
                <div class="row mb-4 font-1-5rem">
                    ...
                    <div class="offset-md-2 offset-sm-4 offset-0 col-md-10 col-sm-8 col-12 d-flex justify-content-between">
                        ...
                        <div>
                            ...
                            <div class="" style="border: 2px dashed #c0c0c0;border-radius:15px;cursor:pointer;">
                                ...
                                <input class="img-cal-upload" name="calendar_image" type="file" accept=".png, .jpg, .jpeg" data-parsley-required data-parsley-max-file-size="10" data-parsley-errors-container="#he-e6"  />
                                <div class="errorMsg d-none" id="he-e6"></div>
                                @if ($errors->has('calendar_image'))
                                    <span class="text-danger">{{ $errors->first('calendar_image') }}</span>
                                @endif

                            </div>
                            <!-- <div class="fileInput-customIcon uploadIcon">
                                <div class="form-fileInput">
                                    <textarea class="form-control" readonly placeholder="Upload Icon" rows="1"></textarea>
                                </div>
                                <input class="form-control fileInput-control d-block visually-hidden" type="file" data-parsley-required data-parsley-max-file-size="10" data-parsley-errors-container="#he-e6" accept=".png, .jpg, .jpeg" name="calendar_image" onchange="loadFile(event)">
                                <div class="errorMsg d-none" id="he-e6"></div>
                            </div> -->
                        </div>
                        <div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="row mb-5">
                            ...
                            <button type="submit" class="btn btn-primary rounded-4 py-1" onClick="eventFormValidate()">Create</button>
                        </div>
                        </div>
                    </div>
